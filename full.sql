...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Сен 13 2018 г., 11:44
...
--
ALTER TABLE `CUSTOMERS`
  ADD CONSTRAINT `customers_ibfk_1` FOREIGN KEY (`CUST_REP`) REFERENCES `SALESREPS` (`EMPL_NUM`) ON DELETE SET NULL;
...
--
ALTER TABLE `ORDERS`
  ADD CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`CUST`) REFERENCES `CUSTOMERS` (`CUST_NUM`) ON DELETE CASCADE,
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`REP`) REFERENCES `SALESREPS` (`EMPL_NUM`) ON DELETE SET NULL,
  ADD CONSTRAINT `orders_ibfk_3` FOREIGN KEY (`MFR`,`PRODUCT`) REFERENCES `PRODUCTS` (`MFR_ID`, `PRODUCT_ID`);
...
ALTER TABLE `SALESREPS`
  ...
  ADD CONSTRAINT `salesreps_ibfk_2` FOREIGN KEY (`REP_OFFICE`) REFERENCES `OFFICES` (`OFFICE`) ON DELETE SET NULL;
COMMIT;
